...
The reminder is best-effort, not guaranteed. If a participant signs up <12h before kickoff, or the cron misses a run, they may not receive one. The app shows missing predictions in the UI either way; the email is a convenience, not a contract.
